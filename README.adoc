= iSAQB Advanced Level curriculum for *EMBEDDED: Safety-critical Embedded Systems*
...
----
Via SSH:
git clone git@github.com:isaqb-org/curriculum-embedded.git --recursive

Via HTTPS:
git clone https://github.com/isaqb-org/curriculum-embedded.git --recursive
----
--
