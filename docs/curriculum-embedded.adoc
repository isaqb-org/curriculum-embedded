...
<<<
:sectnums:
include::01-system-development/00-structure.adoc[{include_configuration}]

<<<
include::02-software-development/00-structure.adoc[{include_configuration}]

<<<
include::03-dependability/00-structure.adoc[{include_configuration}]

<<<
include::04-realtime/00-structure.adoc[{include_configuration}]

<<<
include::05-adaptability/00-structure.adoc[{include_configuration}]

<<<
include::06-advanced-realtime/00-structure.adoc[{include_configuration}]
